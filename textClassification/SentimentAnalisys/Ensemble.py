...
class Ensemble():
    ...
    def load_classifiers(self):
        ...
        svm_product = joblib.load('textClassification/SentimentAnalisys/ClassifierWeigths-wine/svm-02.pkl')
        svm_store = joblib.load('textClassification/SentimentAnalisys/ClassifierWeigths-wine/svm2-02.pkl')
